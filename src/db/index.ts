...
const initialGames: Omit<GameEntity, 'id'>[] = [
  ...
  {
    title: '타이밍 버튼',
    description: '움직이는 인디케이터가 초록색 영역에 있을 때 버튼을 눌러 점수를 획득하세요! 콤보를 쌓으면 속도가 빨라지고 점수도 높아집니다.',
    url: 'internal://timing-button-game',
    thumbnail: null,
    category: 'action',
    tags: ['액션', '리듬', '타이밍', '반응속도'],
    embed_allowed: true,
  ...
  {
    title: '픽셀 컬러링',
    description: '토끼, 사과, 버섯 등 귀여운 템플릿을 선택하고 픽셀 아트를 색칠해보세요! 완성된 작품을 다운로드하거나, 나만의 이미지를 업로드해서 픽셀 아트로 변환할 수도 있습니다.',
    url: 'internal://pixel-coloring-game',
    thumbnail: null,
    category: 'casual',
    tags: ['캐주얼', '픽셀아트', '컬러링', '창작', '다운로드'],
    embed_allowed: true,
    play_count: 0,
    avg_rating: 0,
    rating_count: 0,
